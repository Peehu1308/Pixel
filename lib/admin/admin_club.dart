...
class Clubs_Screen_Admin extends StatefulWidget {
  final String email;

  const Clubs_Screen_Admin({super.key, required this.email});

  @override
  State<Clubs_Screen_Admin> createState() => _Clubs_Screen_AdminState();
}

class _Clubs_Screen_AdminState extends State<Clubs_Screen_Admin> {
  List<dynamic> clubs = [];
  String profileImage = "";
